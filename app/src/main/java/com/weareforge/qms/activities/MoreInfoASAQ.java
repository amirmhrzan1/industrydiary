...
/**
 * Created by prajit on 4/11/16.
 */
public class MoreInfoASAQ extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = new ProgressDialog(MoreInfoASAQ.this);
...
//                Toast.makeText(MoreInfoASAQ.this, description, Toast.LENGTH_SHORT).show();
        ...
        webView.loadUrl("http://www.asqa.gov.au/users-guide-to-the-standards-for-registered-training-organisations- 2015/users-guide-to-the-standards-for-registered-training-organisations-2015.html");
