...
public class Util {
    ...
    public static AmazonS3Client getS3Client(Context context) {
        if (sS3Client == null) {
            ...
            sS3Client.setEndpoint("s3-ap-southeast-2.amazonaws.com");
        }
        return sS3Client;
    }
    ...
    public static void fillMap(Map<String, Object> map, TransferObserver observer, boolean isChecked) {
        ...
        map.put("state", observer.getState().toString());
        map.put("percentage", progress + "%");
    }

    public static void fillMapCompleted(Map<String, Object> map, TransferObserver observer, boolean isChecked) {
        map.put("id", observer.getId());
        map.put("checked", isChecked);
        map.put("fileName", observer.getAbsoluteFilePath());
